...
const CarShowrooms = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get('https://zenreserve-lc.onrender.com/api/business/carshowrooms');
        setData(res.data);
      } catch (err) {
...
const CarShowrooms = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get('https://zenreserve-lc.onrender.com/api/business/carshowrooms'); // ✅ Make sure this route exists
        setData(res.data);
      } catch (err) {
        console.error(err);
      } finally {
